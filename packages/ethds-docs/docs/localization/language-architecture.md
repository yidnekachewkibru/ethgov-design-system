...
- **Ge'ez / Ethiopic script** (`am`, `ti`) requires fonts with full
  Ethiopic coverage — see
  [typography](https://github.com/yidnekachewkibru/ethgov-design-system/blob/main/docs/brand/typography.md).
  The default stack pairs `Noto Sans` (Latin) with `Noto Sans Ethiopic`
...
- Every page sets the document `lang` to the active locale, and any
  ...
  [accessibility/screen-readers](https://github.com/yidnekachewkibru/ethgov-design-system/blob/main/docs/accessibility/screen-readers.md).
