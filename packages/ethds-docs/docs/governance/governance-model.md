...
- **Accessibility and localization changes** additionally require
  sign-off from a designated accessibility or localization reviewer —
  see the [accessibility](accessibility-review-process.md) and
  [localization](localization-review-process.md) review processes.
...
The full contributor progression toward these roles is described in the
[community model](community-model.md).
...
This is the baseline governance model. The detailed
