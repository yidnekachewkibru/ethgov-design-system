...
- [ ] Public API is minimal and consistent with existing components
      ([Simple Before Powerful](https://github.com/yidnekachewkibru/ethgov-design-system/blob/main/docs/design-principles/05-simple-before-powerful.md)).
...
- [ ] Accessibility reviewer sign-off — see the
...
- [ ] Localization reviewer sign-off where user-facing — see the
...
- [ ] Component documented (props, accessibility notes, usage) — see the
      live [Components section](/docs/components).
