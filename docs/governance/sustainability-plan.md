...
- **Minimal dependencies** (e.g. dependency-free `@ethds/tokens`, no
  ...
  ([Security](../design-principles/08-security-and-privacy-by-design.md),
  [Low Bandwidth](../design-principles/06-design-for-low-bandwidth.md)).
...
- Every adopting service that **contributes back** (fixes, components,
  ...
  [Open by Default](../design-principles/10-open-by-default.md)).
...
[success metrics](../foundation/success-metrics.md) (active contributors,
diversity of contributing organisations, time-to-response).
