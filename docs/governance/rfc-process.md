...
[CONTRIBUTING.md](../../CONTRIBUTING.md#proposing-significant-changes) and
the [governance model](governance-model.md). RFCs are archived in
[`packages/ethds-rfcs/`](../../packages/ethds-rfcs/).

This process embodies [Open by Default](../design-principles/10-open-by-default.md):
...
1. **Draft.** Copy [`template.md`](../../packages/ethds-rfcs/template.md),
...
3. **Under Review.** A public comment period (minimum **one week** for
   ...
   accessibility/localization/security reviewers where relevant
...
See the [RFC template](../../packages/ethds-rfcs/template.md) and the
[worked example](../../packages/ethds-rfcs/proposals/0000-example.md).
